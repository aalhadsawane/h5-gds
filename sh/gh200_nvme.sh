...
# for GH200 nodes
source /work/opt/local/modules/aarch64/setup-aarch64.sh

module purge
module load cuda
module use /home/z30118/opt/modules/compiler
module load cuda-samples
module use /home/z30118/opt/modules/lib
module load boost
module load hdf5
module load vfd-gds
...
do
	...
	ROOT=/mnt/nvme1/ymiki.tmp/${GPU_DIR}
	...
	do
		...
		do
			...
			do
				# sync ; echo 3 > /proc/sys/vm/drop_caches # root is required
